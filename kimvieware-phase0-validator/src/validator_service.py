...
# 🔥 IMPORTANT: import strategies + detector
from validators.language_detector import (
    LanguageDetector,
    StrategyRegistry,
    PythonStrategy,
    JavaStrategy,
...
class ValidatorService(MicroserviceBase):
    ...
    def __init__(self):
        ...
        # =====================================================
        # 🔥 FIX IMPORTANT: create detector instance
        # =====================================================
    ...
    def process_message(self, message: dict) -> dict:
        ...
        # =====================================================
        # 🔥 FIX IMPORTANT: use instance, NOT class
        # =====================================================
        lang_info = self.detector.detect(extract_dir, logger=self.logger)
        ...
        # Entry point (from strategy result)
        ...
        sut_info = SUTInfo(
            ...
            size_bytes=sum(f.stat().st_size for f in lang_info['files']) if lang_info['files'] else 0,
